...
export default function HomePage() {
  ...
  return (
    <div
      ...
      px-4 py-10 bg-gradient-to-br from-black via-[#0b0b14] to-[#1b1430]"
    >
      <div className="text-center max-w-[90%] sm:max-w-[500px]">
        <h1
          className="font-extrabold
            text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl
            bg-gradient-to-r from-[#9a7eff] via-[#cbb0ff] to-[#f5e09a]
        ...
        {user ? (
          <button
            onClick={logout}
            className="mt-10 px-6 py-3 rounded-full bg-gradient-to-r from-[#b39aff] via-[#e7d4ff] to-[#f5e09a] font-semibold text-lg text-black hover:opacity-90 transition-all duration-200"
          >
            Logout
          </button>
        ) : (
          <Link
            ...
            className="mt-10 inline-flex items-center gap-3 
              ...
              bg-gradient-to-r from-[#b39aff] via-[#e7d4ff] to-[#f5e09a]
